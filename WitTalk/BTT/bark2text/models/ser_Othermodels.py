...
from models.ser_spec import SER_AlexNet , SER_ResNet , SER_EfficientNet , SER_VIT
...
class Ser_EfficientNet(nn.Module):
    def __init__(self):
        ...
        self.post_spec_dropout = nn.Dropout(p=0.1)
        self.post_spec_layer = nn.Linear(1280, 128) # 9216 for cnn, 32768 for ltsm s, 65536 for lstm l
