...
def test(mode, params, model, criterion_ce, criterion_mml, test_dataset, batch_size, device,
    ...
    for test_batch in test_loader:
        ...
        # Forward
        test_output_att = model(test_data_spec_batch, test_data_mfcc_batch, test_data_audio_batch , test_data_coc_batch , test_conven_batch)
...
def train(dataset, valid_dataset , params, save_label='default'):
    ...
    for epoch in range(params['num_epochs']):
        ...
        for train_batch in train_loader:
            ...
            # Forward pass
            output_att = model(train_data_spec_batch, train_data_mfcc_batch, train_data_audio_batch , train_data_coc_batch , train_conven_batch)
