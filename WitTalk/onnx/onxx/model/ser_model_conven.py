...
class model_convential_lstm(nn.Module):
    def __init__(self):
        super(model_convential_lstm ,self).__init__()
        self.flatten = nn.Flatten()
        #68 * 7

        self.lstm = nn.LSTM(input_size = 6, hidden_size = 16 , num_layers=2 , batch_first=True , dropout= 0.5 , bidirectional=True)
