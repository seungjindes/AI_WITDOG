...
class SERDataset:
    ...
    def __init__(self, features_data, num_classes = 4,
        ...
        self.val_coc_data = features_data[val_speaker_id]['seg_coc'].astype(np.float32)
        ...
        self.test_coc_data = features_data[test_speaker_id]['seg_coc'].astype(np.float32)
        ...
        print(f'Train coc data  : {train_coc_data.shape}')
